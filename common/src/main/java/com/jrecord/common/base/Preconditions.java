...
public final class Preconditions {
    ...
    public static void checkMainThread() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            throw new IllegalThreadStateException("can't do this in main thread");
        }
    }
    ...
    public static <T> void validateInterface(Class<T> service, @Nullable Object errorMessage) {
        if (!service.isInterface()) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        }
    }

    public static <T> void validateClass(Class<T> service, @Nullable Object errorMessage) {
        if (service.isInterface()) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        }
    }
    ...
    public static <T> void validateServiceInterface(Class<T> service) {
        validateInterface(service, "API declarations must be interfaces.");
